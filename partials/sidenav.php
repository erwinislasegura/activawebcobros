                    ...
                    <div class="collapse" id="modulo-mantenedores">
                        <ul class="side-nav sub-menu">
                            <li class="side-nav-item"><a href="municipalidad.php" class="side-nav-link">Empresa</a></li>
                                                        <li class="side-nav-item">
                                <a href="#modulo-email" class="side-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="modulo-email">Email <span class="menu-arrow"></span></a>
                                <div class="collapse" id="modulo-email">
                                    <ul class="side-nav sub-menu">
