                            ...
                            <div class="card-body">
                                ...
                                <form method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="tipo-nombre" name="nombre" class="form-control" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="tipo-descripcion">Descripción</label>
                                        <textarea id="tipo-descripcion" name="descripcion" class="form-control" rows="3"></textarea>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-centered mb-0">
                                        ...
                                        <tbody>
                                            <?php if (empty($tipos)) : ?>
                                                <tr>
                                                    <td colspan="4" class="text-center text-muted">Aún no hay tipos registrados.</td>
                                                </tr>
                                            <?php else : ?>
